...
# Create new module (for example moduletest)
~/odoo-dev/odoo/odoo-bin scaffold moduletest ~/odoo-dev/library-app/


# launch odoo:
~/odoo-dev/odoo/odoo-bin -c ~/odoo-dev/12-library.conf -d 12-library --addons-path=~/odoo-dev/odoo/addons,~/odoo-dev/library-app
